...
type TokenHandlerInterface interface {
	GenerateToken(interaction dto.InteractionType, adID, publisherID uint, bid int64, redirectPath string, key []byte) (string, error)
...
func (th *TokenHandlerService) GenerateToken(interaction dto.InteractionType, adID, publisherID uint, bid int64, redirectPath string, key []byte) (string, error) {
